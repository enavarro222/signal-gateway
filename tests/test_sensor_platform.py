"""Tests for Signal Gateway sensor platform setup."""
...
async def test_async_setup_entry_with_contacts_and_groups(
    mock_hass_sensor, mock_entry, mock_signal_client, sample_contact, sample_group
):
    """Test sensor platform setup with contacts and groups."""
    ...
    await async_setup_entry(mock_hass_sensor, mock_entry, async_add_entities)
    ...
    # Verify 2 sensor entities were created (1 contact + 1 group)
...
async def test_async_setup_entry_no_contacts_or_groups(
    mock_hass_sensor, mock_entry, mock_signal_client
):
    """Test sensor platform setup with no contacts or groups."""
...
async def test_async_setup_entry_api_error(
    ...
    """Test sensor platform setup when API calls fail."""
